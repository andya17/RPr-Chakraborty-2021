...
**Reanalysis change**: The above change to the table transposes it so that it fits on the page. This allows the reader to see all values and thus understand the section more readily.
...
**Reanalysis change**: The above change to the plot may allow for easier viewing of the outlier points (outside of the clump of points representing low percentages of Native Americans)
...
**Reanalysis change**: The above change to the map removed the parameter "midpoint" and thus allowed for the visualization of the full color ramp.
...
**Reanalysis change**: The above change integrates the two previous discussion sections (by Emily and Professor Holler) into one discussion section with limited additional content. This change will hopefully permit readers to understand the discussion of the paper as a more cohesive section.
